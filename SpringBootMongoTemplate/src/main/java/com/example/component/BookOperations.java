...
//        );
        ...
        //region Using insertAll(Collection<? extends T> ObjectsToSave)
...
//        ));
        ...
        //region findAll(className)  OR  findAll(className, collectionName)
...
//List<Book> list = mt.findAll(Book.class,"Book");  //If collection name & the Entity Class Name are different (case-sensitive)
        ...
        //region findById(id, entityClass)  OR  findById(id, entityClass, collectionName)
        Book book = mt.findById(504, Book.class);
//Book book = mt.findById(501, Book.class,"Book");
        System.out.println(book);
        //endregion

        //region findAndModify(query, update, entityClassName)
        ...
        //region updateMulti(query, update, entityClassName)
        Query query1 = new Query();
        query1.addCriteria(Criteria.where("pages").lte(180));
        Update update1 = new Update();
        update1.set("cost", 999.0);
        mt.updateMulti(query1, update, Book.class);
        //endregion

        //region findAndRemove(query, entityClassName)
        Query query2 = new Query();
        query2.addCriteria(Criteria.where("cost").is(1749.0));
        mt.findAndRemove(query2, Book.class);
        //endregion

        //region findAllAndRemove(query, entityClassName)
        ...
        //region upsert(query, update, entityClassName)
        Query query4 = new Query();
        query4.addCriteria(Criteria.where("id").is(510));
